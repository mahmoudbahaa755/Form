...
export default function DomainDetails(){
    return (
      <Box mb={5} fontWeight='500' fontSize={18} display='flex' flexDirection='column' rowGap='20px'  sx={{ padding: "0 1rem", width:' 30% '}}>
...
<Box  display={'flex'} justifyContent='space-between' flexWrap='wrap' gap='5px'>
        ...
        <Typography display={'flex'} alignItems='center' fontSize={16}  gap='5px' variant="body2">
          <CheckCircleSVG/> Privacy protection is on
        </Typography>
        <Typography display={'flex'} alignItems='center' fontSize={16} fontWeight={500} color='#000' gap='5px' variant="body2"> 
